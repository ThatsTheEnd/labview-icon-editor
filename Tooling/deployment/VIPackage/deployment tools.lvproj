	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="vi.lib" Type="Folder">
				...
				<Item Name="GIT-api.ctl" Type="VI" URL="/&lt;vilib&gt;/Hampel Software Engineering/Git API/Git API/GIT-api.lvclass/GIT-api.ctl"/>
				<Item Name="GIT-Set Working Dir.vi" Type="VI" URL="/&lt;vilib&gt;/Hampel Software Engineering/Git API/Git API/Accessors/GIT-Set Working Dir.vi"/>
				<Item Name="GIT-Create API.vi" Type="VI" URL="/&lt;vilib&gt;/Hampel Software Engineering/Git API/Git API/GIT-Create API.vi"/>
				<Item Name="GIT-Repository Top Level.vi" Type="VI" URL="/&lt;vilib&gt;/Hampel Software Engineering/Git API/Git API/API/High Level/GIT-Repository Top Level.vi"/>
				<Item Name="GIT-Untracked Files.vi" Type="VI" URL="/&lt;vilib&gt;/Hampel Software Engineering/Git API/Git API/API/High Level/GIT-Untracked Files.vi"/>
				<Item Name="GIT-Unstages Files.vi" Type="VI" URL="/&lt;vilib&gt;/Hampel Software Engineering/Git API/Git API/API/High Level/GIT-Unstages Files.vi"/>
				<Item Name="GIT-Add.vi" Type="VI" URL="/&lt;vilib&gt;/Hampel Software Engineering/Git API/Git API/API/Basic/GIT-Add.vi"/>
				<Item Name="GIT-Commit.vi" Type="VI" URL="/&lt;vilib&gt;/Hampel Software Engineering/Git API/Git API/API/Basic/GIT-Commit.vi"/>
				<Item Name="GIT-api.lvclass" Type="LVClass" URL="/&lt;vilib&gt;/Hampel Software Engineering/Git API/Git API/GIT-api.lvclass"/>
