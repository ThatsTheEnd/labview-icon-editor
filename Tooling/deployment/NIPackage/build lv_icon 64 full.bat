...
LabVIEWCLI -OperationName RunVI -VIPath "C:\labview-icon-editor\Tooling\deployment\NIPackage\Modify icon editor project to deploy to LVAddons.vi" "C:\labview-icon-editor\lv_icon_editor.lvproj" "Editor Packed Library" -LabVIEWPath "C:\Program Files\National Instruments\LabVIEW 2021\LabVIEW.exe" -PortNumber 3366 -LogFilePath "C:\Users\Public\CLIlog1.txt" -Verbosity Detailed -LogToConsole TRUE
...
LabVIEWCLI -OperationName RunVI -VIPath "C:\labview-icon-editor\Tooling\deployment\NIPackage\Create LVAddon JSON file.vi" -LabVIEWPath "C:\Program Files\National Instruments\LabVIEW 2021\LabVIEW.exe" -PortNumber 3366 -LogFilePath "C:\Users\Public\CLIlog3.txt" -Verbosity Detailed -LogToConsole TRUE
REM Build the NI Package
cd /d C:\Program Files\National Instruments\Package Builder
nipbcli -o="C:\labview-icon-editor\Tooling\deployment\NIPackage\LVAddonIE_x64.pbs" -b=packages
